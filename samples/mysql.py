...
def result():
    ...
    # RESULT테이블의 QUETSION_ID랑 CHOICE_ID 두개를 가져가.
    # 이 두개로 CHOICE 테이블에서 QUETSION_ID랑 CHOICE_NUM 두개가 일치하는 것의
    # CHOICE_CORRECT가 '정답'이면 QUESTION테이블의 QUESTION_SCORE의 숫자를 SUM 하는거야.
    # '정답'이 아니라 NULL값이면 SUM에 포함 안시키고
